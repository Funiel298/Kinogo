...
export default function Nav({children}:any){
    return(
        <>
           <header className=" flex flex-row justify-around items-center absolute z-10 w-full" >
                <nav className="  w-4/5 py-2 flex flex-row justify-around items-center">
                    <Link href={'./'}><img src={Logo.src} alt="kinogo" width={50} /></Link>
                    <ul className=" flex flex-row justify-around w-1/3 text-white font-medium " >  
           ...
           <footer className="bg-gray-800 ">
                <nav className=" w-full p-5 flex flex-row justify-around items-center">
                    <Link href={'./'}><img src={Logo.src} alt="kinogo" width={50} /></Link>
