                ...
                <div className="flex items-center justify-center m-10">
                    ...
                    <div className="w-96 ml-20">   
                        ...
                        <div className="flex flex-col justify-between w-full ">
                            ...
                            <h6 className="text-sm mt-3">Known for: {post.known_for_department} </h6>
                        </div>
                        <h4 className="text-sm text-gray-300">{post.overview}</h4>
                        <h4 className="text-sm text-gray-300">{post.biography}</h4>
                        <div className=" mt-4">
                        ...
                        <div className="border-b-2  mb-2 flex flex-row justify-between items-center">
                            ...
                            <div  className="flex flex-row flex-wrap justify-end w-3/5">
                                <p className="text-sm text-gray-600 ">{post.popularity}</p> 
                            </div>
