...
export default function Card(props: any){
    ...
    return(
        <div className=" h-full lg:h-1/2 lg:w-11/12 rounded-3xl mr-5  w-128  flex flex-col  ">
            ...
            <div className="absolute h-full flex flex-col mb-10 p-10 justify-end rounded-3xl text-white bg-gradient-to-r from-black">
                ...
                <Link  href={props.link}><button className="bg-red-400 p-3 font-semibold rounded-xl mt-5  w-32 md:w-16 md:text-xl md:font-medium" >Watch Trailer</button></Link>
