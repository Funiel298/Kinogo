...
export default function Card(props: any){
    ...
    return(
        <div className=" h-full  w-full  flex flex-col ">
            <h1 className="absolute p-10 font-semibold text-sm text-white z-10">Playing Now</h1>
            ...
            <div className="absolute h-full flex flex-col mb-10 p-10 justify-end text-white bg-gradient-to-r from-black">
